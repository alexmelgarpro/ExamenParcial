...
namespace practica
{
    public class EmpleadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Codigo,Nombre,LugarNacimiento,FechaNacimiento,Telefono,Cargo,Estado")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Codigo,Nombre,LugarNacimiento,FechaNacimiento,Telefono,Cargo,Estado")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
